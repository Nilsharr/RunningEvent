                ...
                <div>
                    <Form onSubmit={handleAddEvent} ref={form}>
                        ...
                        <div className="form-group">
                            ...
                            />
                            {(message && message.eventError && message.eventError.invalidDate) && (
                                <div className="form-group">
                                    <div className="alert alert-danger" role="alert">
                                        {message.eventError.invalidDate}
                                    </div>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            <Input
                                ...
                                validations={[required]}
                            />
                            {(message && message.eventError && (message.eventError.notEnoughParticipants || message.eventError.tooManyParticipants)) && (
                                <div className="form-group">
                                    <div className="alert alert-danger" role="alert">
                                        {message.eventError.notEnoughParticipants || message.eventError.tooManyParticipants}
                                    </div>
                                </div>
                            )}
                        </div>
